...
class DES():
	...
	def code(self,from_code,key,code_len,key_len):
		...
		for i in range(0,trun_len,64):
            ...
            run_key = code_key[0:128]
            key_base = code_key[128:192]
			...
			for j in range(16):
                ...
                key_l = run_key[4:64]
                key_l = key_l + temp_l
                temp_r = run_key[64:68]
                key_r = run_key[68:128]
                key_r = key_r + temp_r

                temp_b = key_base[0:4]
                key_base = key_base[4:64]
                key_base = key_base + temp_b


				run_key = key_l + key_r

                temp_key_1 = self._codeXOR(key_l,key_r) 
                temp_key_2 = self._codeXOR(temp_key_1,key_base)
                temp_key_3 = self._codeXOR(temp_key_2[0:16],temp_key_2[16:32]) 
                temp_key_4 = self._codeXOR(temp_key_2[32:48],temp_key_2[48:64]) 
                temp_key_5 = self._codeXOR(temp_key_3,temp_key_4)

				key_y = temp_key_5 + temp_key_5 + temp_key_5
...
if __name__  == '__main__':
	...
	print desencode('我是12345678刘就是我abcdwfd','qazwsxedcrfvtqwrfqwereqwterwygbyhnujm')